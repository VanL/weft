...
Global raw-`noqa` inventory: `C901=152`, `E402=22`, `F401=5`
...
| `RUFF-SUP-101` | `weft/_constants.py::_normalize_weft_override_value` | 1 | `C901=1` |
| `RUFF-SUP-102` | `weft/cli/app.py::task_status` | 1 | `C901=1` |
| `RUFF-SUP-103` | `weft/cli/validate_taskspec.py::_display_taskspec_summary` | 1 | `C901=1` |
