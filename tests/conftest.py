...
_SHARED_MODULES = frozenset(
    {
        ...
        "tests/cli/test_cli_status_rendering.py",
        "tests/cli/test_result_claimed_json.py",
        "tests/cli/test_retired_command_rendering.py",
        ...
        "tests/core/test_builtin_agent_probe.py",
        ...
        "tests/core/test_process_title.py",
        "tests/core/test_manager_services.py",
        "tests/core/test_monitor_collation.py",
        "tests/core/test_monitor_external_log.py",
        "tests/core/test_monitor_helper_connections.py",
        "tests/core/monitor/test_progress.py",
        ...
        "tests/core/test_service_helper_connections.py",
        ...
        "tests/core/test_terminal_handoff_transport.py",
