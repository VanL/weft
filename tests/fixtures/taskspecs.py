...
def create_minimal_taskspec(tid: str = "1234567890123456789") -> TaskSpec:
...
MINIMAL_VALID_TASKSPEC_DICT: dict[str, Any] = {
    ...
    "io": {
        ...
        "outputs": {"outbox": "T1234567890123456789.outbox"},
        "control": {
            "ctrl_in": "T1234567890123456789.ctrl_in",
            "ctrl_out": "T1234567890123456789.ctrl_out",
        },
    },
    "state": {
        "status": "created",
...
VALID_FUNCTION_TASKSPEC_DICT: dict[str, Any] = {
    ...
    "io": {
        "inputs": {"inbox": "T1234567890123456789.inbox"},
        "outputs": {"outbox": "T1234567890123456789.outbox"},
        "control": {
            "ctrl_in": "T1234567890123456789.ctrl_in",
            "ctrl_out": "T1234567890123456789.ctrl_out",
...
VALID_COMMAND_TASKSPEC_DICT: dict[str, Any] = {
    ...
    "io": {
        "inputs": {"stdin": "T1234567890123456789.stdin"},
        "outputs": {
            "outbox": "T1234567890123456789.outbox",
            "stdout": "T1234567890123456789.stdout",
            "stderr": "T1234567890123456789.stderr",
        },
        "control": {
            "ctrl_in": "T1234567890123456789.ctrl_in",
            "ctrl_out": "T1234567890123456789.ctrl_out",
...
INVALID_MEMORY_LIMIT: dict[str, Any] = {
    ...
    "spec": {
        "type": "function",
        "function_target": "test:func",
        "memory_limit": -100,  # Invalid negative
    },
    "io": {
        "inputs": {},
        "outputs": {"outbox": "test.out"},
